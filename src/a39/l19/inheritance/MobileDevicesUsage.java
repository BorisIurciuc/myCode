...
public class MobileDevicesUsage {
  public static void main(String[] args) {
    ...
    // пример нисходящего присвоения, когда в класс-наследник сохраняется значение родителя.
    // в этом случае мы обязаны явно привести тип данных, тк за частую это приводит к ошибкам
    // в виду того, что в классе наследнике может быть больше функционала, которого нет в
    // классе-родителе
    // Пример:
