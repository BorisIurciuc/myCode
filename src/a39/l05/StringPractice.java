...
public class StringPractice {
  public static void main(String[] args) {
    ...
    System.out.println("9 Обрезанная и извлеченная подстрока: " + trimmedAndSub);
    ...
    System.out.println("10 Индекс 'JAVA' после преобразования в верхний регистр: " + indexAfterUpper);
    ...
    System.out.println("11 Измененная и приведенная к нижнему регистру строка: " + replacedAndLower);
    ...
    System.out.println("12 Равны ли строки после trim и игнорирования регистра: " + isEqualTrimAndIgnoreCase);
    ...
    System.out.println("13 Подстрока в верхнем регистре: " + subAndUpper);
    ...
    System.out.println("14 Измененная строка: " + replacedStr14);
  }
}