...
public class Smartphone implements Phone, Camera, MusicPlayer {
  ...
  @Override
  public void makeCall(String number) { System.out.println(model + ": Making a call to " + number);  }
  @Override
  public void receiveCall(String caller) { System.out.println(model + ": Receiving a call from " + caller);  }
  @Override
